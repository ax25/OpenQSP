...
The former M4.2/M4.3 application-ID retry and conflict scenarios were removed.
Retry identifiers, duplicate suppression, and replay belong to a future
unreliable-transport adapter; repeating a Core send is a new application
submission.
